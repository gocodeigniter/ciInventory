...
$route['pegawai/export'] = 'pegawai/exportPdf';
...
$route['inventaris/export'] = 'inventaris/exportPdf';
...
$route['peminjaman/export'] = 'peminjaman/exportPdf';
...
$route['detail/export'] = 'detail/exportPdf';
